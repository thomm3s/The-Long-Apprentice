...
## global_transform to face the intended direction before adding it to the
## tree (forward is -Z, matching Player._camera_raycast's convention) — this
## scene doesn't know or care who cast it. Flies forward at a constant
